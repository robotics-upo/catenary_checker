...
CorrectionParabolaParametersSolver::CorrectionParabolaParametersSolver(Grid3d* g_3D_, double d_tether_obs_, double l_tether_max_, int i_, geometry_msgs::Vector3 plr_) 
{
