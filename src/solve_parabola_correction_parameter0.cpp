...
CorrectionParabolaParametersSolver::CorrectionParabolaParametersSolver(Grid3d* g_3D_, Grid3d* g_3D_obst_, Grid3d* g_3D_trav_, double d_tether_obs_, double l_tether_max_, int i_, geometry_msgs::Vector3 plr_) 
{
  // google::InitGoogleLogging("CatenaryCeresSolver");
  max_num_iterations = 500;
  grid_3D = g_3D_;
  grid_3D_obst = g_3D_obst_;
  grid_3D_trav = g_3D_trav_;
...
void CorrectionParabolaParametersSolver::loadInitialStatus(geometry_msgs::Vector3 p1_, geometry_msgs::Vector3 p2_, double pa_, double pb_, double pc_)
{
