...
public:
    ...
    void Init(double dist_cat_, double l_cat_max_, double ws_z_min_, double step_);
    void SearchCatenary(const geometry_msgs::PointConstPtr &pi_, const geometry_msgs::PointConstPtr &pf_, std::vector<geometry_msgs::Point> &pts_c_);
    bool NumericalSolutionCatenary(const geometry_msgs::PointConstPtr &p_reel_, 
								   const geometry_msgs::PointConstPtr &p_final_, 
